...
TEST(ConceptTest, CombinedScenarios) {
  ...
  ASSERT_TRUE(!argparse::ParseFromStringType<std::vector<std::optional<int>>>);
  ASSERT_TRUE(!argparse::ParseFromStringType<std::optional<std::vector<int>>>);
}
...
TEST(ConceptTest, ParseFromStringTupleLikeType) {
  ...
  // 包含自定义类型的元组测试
  ASSERT_TRUE((
      argparse::ParseFromStringTupleLikeType<std::tuple<StringConstructible>>));
  ASSERT_TRUE(
...
TEST(ConceptTest, ParseFromStringOptionalSingleType) {
  ...
  ASSERT_TRUE((
      argparse::ParseFromStringOptionalSingleType<std::optional<std::string>>));
...
TEST(ConceptTest, BindableWithoutDelimiterType) {
  ...
  ASSERT_TRUE((argparse::BindableWithoutDelimiterType<std::list<std::string>>));
  ...
  ASSERT_FALSE((argparse::BindableWithoutDelimiterType<
                std::vector<std::pair<int, int>>>));
  ASSERT_FALSE(argparse::BindableWithoutDelimiterType<NonStringConstructible>);
  ASSERT_FALSE((argparse::BindableWithoutDelimiterType<
                std::optional<std::pair<int, int>>>));
}
...
TEST(ConceptTest, BindableWithDelimiterType) {
  ...
  // optional元组类型测试
  ASSERT_TRUE((
      argparse::BindableWithDelimiterType<std::optional<std::pair<int, int>>>));
  ASSERT_TRUE((argparse::BindableWithDelimiterType<
               std::optional<std::tuple<int, std::string>>>));
  ASSERT_TRUE(
      (argparse::BindableWithDelimiterType<std::optional<std::array<int, 3>>>));
